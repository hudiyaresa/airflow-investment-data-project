...
@task_group
def investment_csv(incremental):
    """
    Task group to handle the extraction and loading of Investment csv data.
    ...
    def extract():
        """
        Task group to handle the extraction of data from Investment csv.
        """
        # Get the list of tables to extract from Airflow Variable
        table_to_extract = eval(Variable.get('list_investment_csv'))
    ...
    def load():
        """
        Task group to handle the loading of data into Investment csv.
        """
        # Get the list of tables to load and their primary keys from Airflow Variable
        table_to_load = eval(Variable.get('list_investment_csv'))
